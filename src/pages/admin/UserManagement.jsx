...
function UserManagement() {
    ...
    const searchUsers = async (query) => {
        ...
        try {
            const response = await fetch(`http://localhost:3000/admin/users/search?query=${encodeURIComponent(query)}`, {
                credentials: 'include'
            });
    ...
    const handleEditSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`http://localhost:3000/admin/users/${editUser.user_id}`, {
                method: 'PUT',
                credentials: 'include',
                headers: {
            ...
            if (editForm.password) {
                const passwordResponse = await fetch(`http://localhost:3000/admin/users/${editUser.user_id}/password`, {
                    method: 'PUT',
                    credentials: 'include',
                    headers: {
                        'Content-Type': 'application/json',
                                        ...
                                        <div className="space-y-3">
                                            <div className="grid grid-cols-2 gap-3">
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        className={`w-full px-3 py-1.5 text-sm bg-black/30 border rounded-lg focus:outline-none focus:ring-1 ${formErrors.username
                                                ...
                                                <div>
                                                    ...
                                                    <select
                                                        ...
                                                        value={editForm.role}
                                                        onChange={handleEditChange}
                                                        className={`w-full px-3 py-1.5 text-sm bg-black/30 border rounded-lg focus:outline-none focus:ring-1 ${formErrors.role
                                                            ? 'border-red-500/50 focus:ring-red-500/30'
                                                            : 'border-white/10 focus:ring-[#7C5DF9]/50'
                                                            } cursor-pointer`}
                                                    >
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={handleEditChange}
                                                    className={`w-full px-3 py-1.5 text-sm bg-black/30 border rounded-lg focus:outline-none focus:ring-1 ${formErrors.email
                                                        ? 'border-red-500/50 focus:ring-red-500/30'
                                                        : 'border-white/10 focus:ring-[#7C5DF9]/50'
                                                        } cursor-pointer`}
                                                />
                                                ...
                                                <div className="grid grid-cols-2 gap-3">
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={handleEditChange}
                                                            className={`w-full px-3 py-1.5 text-sm bg-black/30 border rounded-lg focus:outline-none focus:ring-1 ${formErrors.password
                                                                ? 'border-red-500/50 focus:ring-red-500/30'
                                                                : 'border-white/10 focus:ring-[#7C5DF9]/50'
                                                                } cursor-pointer`}
                                                        />
                                                    ...
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            onChange={handleEditChange}
                                                            className={`w-full px-3 py-1.5 text-sm bg-black/30 border rounded-lg focus:outline-none focus:ring-1 ${formErrors.confirmPassword
                                                                ? 'border-red-500/50 focus:ring-red-500/30'
                                                                : 'border-white/10 focus:ring-[#7C5DF9]/50'
                                                                } cursor-pointer`}
                                                        />
