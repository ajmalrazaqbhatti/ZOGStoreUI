        ...
        <div className="bg-black  min-h-screen flex items-center justify-center p-4 font-['Product_Sans']" style={{ backgroundImage: `url(${overlay})`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
            <div className="w-96 bg-white/5  rounded-[40px] overflow-hidden flex flex-col justify-center items-center h-fit p-5  border border-white/10">
                <div className="p-6 flex justify-center items-center">
                    <img src={logo} alt="ZOG Store Logo" className="h-20 drop-shadow-[0_0_10px_rgba(167,139,250,0.2)]" />
                </div>
                ...
                <div className="flex flex-col justify-center items-center w-full">
                    ...
                    <div className="mt-8 text-center text-sm">
                        ...
                        <a href="/signup" className="ml-1 font-medium text-indigo-400 hover:text-indigo-300 transition-colors">
                            Sign up
                        </a>
                    </div>
                </div>
